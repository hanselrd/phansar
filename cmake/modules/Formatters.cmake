  ...
  if(${ARG_NAME}_EXECUTABLE)
    ...
    add_custom_target(
      ...
      COMMAND ${CMAKE_COMMAND} -E make_directory
              ${CMAKE_BINARY_DIR}/check-format-${ARG_NAME})
    add_custom_target(check-format-${ARG_NAME}
    ...
    if(ARG_POSTFIX_COMMAND)
      ...
      add_custom_target(fix-format-${ARG_NAME}
                        DEPENDS fix-format-${ARG_NAME}-tmpdir)
    endif()
    ...
    foreach(file IN LISTS files)
      ...
      add_dependencies(check-format-${ARG_NAME}
                       check-format-${ARG_NAME}-${hash})
  ...
  if(CLANG_APPLY_REPLACEMENTS_EXECUTABLE)
    ph_add_formatter(
      ...
      PROGRAMS clang-tidy
               ...
               clang-tidy-11
               clang-tidy-12
      CHECK_ARGS -extra-arg=-Wno-unknown-warning-option -warnings-as-errors="*"
                 %FILE%
      FIX_ARGS -extra-arg=-Wno-unknown-warning-option
               -export-fixes=%TMPDIR%/%ID%.yaml %FILE%
      POSTFIX_COMMAND
        ${CLANG_APPLY_REPLACEMENTS_EXECUTABLE}
        -format
        -style=file
