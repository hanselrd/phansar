...
auto debug_visitor::operator=(const debug_visitor & _other) -> debug_visitor & = default;

debug_visitor::debug_visitor(debug_visitor && _other) noexcept = default;

auto debug_visitor::operator=(debug_visitor && _other) noexcept -> debug_visitor & = default;
