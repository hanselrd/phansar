...
executor_fixture<T>::executor_fixture() {
    ...
    executor = &common::g_service_container.service<common::service::executor_service>();
}

template <class T>
executor_fixture<T>::executor_fixture(const executor_fixture & _other) = default;
...
template <class T>
executor_fixture<T>::executor_fixture(executor_fixture && _other) noexcept = default;
