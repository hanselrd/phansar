#ifndef PHANSAR_COMMON_RTTR_PYBIND_VISITOR_HPP
#define PHANSAR_COMMON_RTTR_PYBIND_VISITOR_HPP
...
public:
    ...
    template <class T>
    void
    visit_getter_setter_property(const ::rttr::visitor::property_getter_setter_info<T> & _info);
    template <class T>
...
#include <phansar/common/rttr/pybind_visitor.inl>
