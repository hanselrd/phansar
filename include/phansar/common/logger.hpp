...
#include <version>
    ...
    #include <source_location>
      ...
      #warning                                                                 \
          "clang supports source_location now so we can remove all of the preprocessor magic"
    #endif
  #endif
#endif
...
public:
  ...
  #if __has_include(<source_location>) && defined(__cpp_lib_source_location)
  void
  smart_log(spdlog::level::level_enum _level,
