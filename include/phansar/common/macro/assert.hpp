...
#define PH_ASSERT_ALWAYS_IF_FREESTANDING(_enable, _condition)                                      \
    ...
    #define PH_ASSERT_FREESTANDING(_condition) PH_ASSERT_ALWAYS_FREESTANDING(_condition)
...
#define PH_ASSERT_ALWAYS_IF(_enable, _condition)                                                   \
    ...
    #define PH_ASSERT_IF(_enable, _condition) PH_ASSERT_ALWAYS_IF(_enable, _condition)
#else
